    ...
    public void drawBlockBreaking(EntityPlayer entityplayer, MovingObjectPosition movingobjectposition, int i, ItemStack itemstack, float f)
    {
        ...
        if(i == 0)
        {
            if(damagePartialTime > 0.0F)
            {
                ...
                int j = renderEngine.getTexture("/betaexpansion/terrain.png");
                ...
                globalRenderBlocks.renderBlockUsingTexture(block, movingobjectposition.blockX, movingobjectposition.blockY, movingobjectposition.blockZ, Util.normalizeTexture(240) + (int)(damagePartialTime * 10F));
                tessellator.draw();
        ...
        if(itemstack != null)
        {
            ...
            int l = renderEngine.getTexture("/betaexpansion/terrain.png");
