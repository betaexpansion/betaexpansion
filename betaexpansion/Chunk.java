...
public class Chunk
{
    ...
    public Chunk(World world, byte abyte0[], byte metadata[], int i, int j)
    {
        this(world, i, j);
        blocks = abyte0;
        data = new NibbleArray(metadata);
        skylightMap = new NibbleArray(abyte0.length);
        blocklightMap = new NibbleArray(abyte0.length);
    }
    ...
    public void markDirty(int i, int j, int k){
    ...
    public void setChunkBlockTileEntity(int i, int j, int k, TileEntity tileentity)
    {
        ...
        if(getBlockID(i, j, k) == 0 || !(Block.blocksList[getBlockID(i, j, k)] instanceof BlockContainer || Block.blocksList[getBlockID(i, j, k)] instanceof BlockJackOLantern))
        {
