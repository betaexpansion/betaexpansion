...
public class EntityItem extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        field_803_e++;
        age++;
        int under = worldObj.getBlockId(MathHelper.floor_double(posX), MathHelper.floor_double(boundingBox.minY) - 1, MathHelper.floor_double(posZ));
        if(age >= 6000 && Block.blocksList[under] instanceof BlockTable == false){
            setEntityDead();
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        int under = worldObj.getBlockId(MathHelper.floor_double(posX), MathHelper.floor_double(boundingBox.minY) - 1, MathHelper.floor_double(posZ));
    	if (Block.blocksList[under] instanceof BlockTable && !entityplayer.isSneaking()){
    			return;
    	}
