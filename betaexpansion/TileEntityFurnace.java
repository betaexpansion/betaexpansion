    ...
    implements IInventory
{
    ...
    private boolean canSmelt()
    {
        ...
        ItemStack itemstack = FurnaceRecipes.smelting().getSmeltingResult(new ItemStack(furnaceItemStacks[0].getItem(), 1, furnaceItemStacks[0].getItemDamage()));
        if(itemstack == null)
        {
            return false;
        }
    ...
    public void smeltItem()
    {
        ...
        if(furnaceItemStacks[2] == null)
        {
            ...
            if (itemstack.getItem() == Item.bread){
            	EntityItem item = new EntityItem(worldObj, this.xCoord, this.yCoord + 1, this.zCoord, new ItemStack(Item.bread, 1));
            	item.addVelocity(0f, 0.1f, 0f);
            	worldObj.entityJoinedWorld(item);
            	furnaceItemStacks[2] = null;
            }
            if (itemstack.getItem() == BEItems.popcorn){
            	EntityItem item = new EntityItem(worldObj, this.xCoord, this.yCoord + 1, this.zCoord, new ItemStack(BEItems.popcorn, 1));
            	item.addVelocity(0f, 0.1f, 0f);
            	worldObj.entityJoinedWorld(item);
            	furnaceItemStacks[2] = null;
            }
