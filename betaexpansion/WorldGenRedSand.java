...
public class WorldGenRedSand extends WorldGenerator {
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                        ...
                        if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockId(k2, l2, i3) == Block.sand.blockID)
                        {
                            world.setBlock(k2, l2, i3, BEBlocks.redSand.blockID);
                            for (int temp = l2; temp > 0; temp--){
                            	if (world.getBlockId(k2, temp, i3) == Block.sand.blockID){
                            		world.setBlock(k2, temp, i3, BEBlocks.redSand.blockID);
                            	} else if (world.getBlockId(k2, temp, i3) == Block.sandStone.blockID){
                            		world.setBlock(k2, temp, i3, BEBlocks.redSandstone.blockID);
                            	} else if (temp < 50){
                            		break;
                            	}
                            }
