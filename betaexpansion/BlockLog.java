...
public class BlockLog extends Block
{
    ...
    protected BlockLog(int i)
    {
        ...
        blockIndexInTexture = Util.normalizeTexture(20);
    }
    ...
    public int getBlockTextureFromSideAndMetadata(int i, int j)
    {
        if(i == 1)
        {
            switch (j){
            case 1:
            	return Util.tex(15, 19);
            case 2:
            	return Util.tex(14, 19);
            default:
            	return Util.normalizeTexture(21);
            }
        }
        if(i == 0)
        {
        ...
        if(j == 1)
        {
            return Util.normalizeTexture(116);
        }
        return j != 2 ? Util.normalizeTexture(20) : Util.normalizeTexture(117);
    }
