...
public final class ItemStack
{
    ...
    public boolean equals(Object other){
    	if (other == null || !(other instanceof ItemStack)){
    		return false;
    	}
    	ItemStack otherItem = (ItemStack) other;
    	return this.stackSize == otherItem.stackSize && 
    		   this.itemDamage == otherItem.itemDamage && 
    		   this.itemID == otherItem.itemID;
    }
    
    @Override
    public int hashCode(){
    	return Objects.hash(stackSize, itemDamage, itemID);
    }
