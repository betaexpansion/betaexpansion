...
public class TextureCompassFX extends TextureFX
{
    ...
    public TextureCompassFX(Minecraft minecraft)
    {
        ...
        try
        {
            BufferedImage bufferedimage = ImageIO.read((net.minecraft.client.Minecraft.class).getResource("/betaexpansion/items.png"));
            int i = (iconIndex % 64) * 16;
            int j = (iconIndex / 64) * 16;
