...
public class EntityDiggingFX extends EntityFX
{
    ...
    public EntityDiggingFX func_4041_a(int i, int j, int k)
    {
        ...
        {
            int l = block.colorMultiplier(worldObj, i, j, k);
    ...
    {
    	float f6 = ((float)(particleTextureIndex % 64) + (particleTextureJitterX / 4F)) / 64F;
        float f7 = f6 + 0.00390625F;
        float f8 = ((float)(particleTextureIndex / 64) + (particleTextureJitterY / 4F)) / 64F;
        float f9 = f8 + 0.00390625F;
