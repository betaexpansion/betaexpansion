...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLiving entityliving, ItemStack itemstack)
    {
        ...
        {
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture("/betaexpansion/terrain.png"));
        ...
        } else
        {
            ...
            {
                GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture("/betaexpansion/items.png"));
            }
            Tessellator tessellator = Tessellator.instance;
            int i = entityliving.getItemIcon(itemstack);
            float f = ((float)((i % 64) * 16) + 0.0F) / 1024F;
            float f1 = ((float)((i % 64) * 16) + 15.99F) / 1024F;
            float f2 = ((float)((i / 64) * 16) + 0.0F) / 1024F;
            float f3 = ((float)((i / 64) * 16) + 15.99F) / 1024F;
            float f4 = 1.0F;
            float f5 = 0.0F;
            float f6 = 0.3F;
            ...
            for(int j = 0; j < 16; j++)
            {
                ...
                float f13 = (f1 + (f - f1) * f9) - (0.001953125F / 4);
                float f17 = f4 * f9;
            ...
            for(int k = 0; k < 16; k++)
            {
                ...
                float f14 = (f1 + (f - f1) * f10) - (0.001953125F / 4);
            ...
            for(int l = 0; l < 16; l++)
            {
                ...
                float f15 = (f3 + (f2 - f3) * f11) - (0.001953125F / 4);
            ...
            for(int i1 = 0; i1 < 16; i1++)
            {
                ...
                float f16 = (f3 + (f2 - f3) * f12) - (0.001953125F / 4);
                float f20 = f4 * f12;
    ...
    public void renderOverlays(float f)
    {
        ...
        {
            int i = mc.renderEngine.getTexture("/betaexpansion/terrain.png");
        ...
        if(mc.thePlayer.isEntityInsideOpaqueBlock())
        {
            ...
            int j1 = mc.renderEngine.getTexture("/betaexpansion/terrain.png");
    ...
    private void renderFireInFirstPerson(float f)
    {
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            float f4 = (float)l / 1024F;
            float f5 = ((float)l + 15.99F) / 1024F;
