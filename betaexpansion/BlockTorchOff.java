...
public class BlockTorchOff extends ModBlock {

	protected BlockTorchOff(int i, int j, String name) {
    ...
    public boolean blockActivated(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
    	...
    	if (entityplayer.getCurrentEquippedItem().itemID == Item.flintAndSteel.shiftedIndex){
        	world.setBlockAndMetadataWithNotify(i, j, k, Block.torchWood.blockID, world.getBlockMetadata(i, j, k));
