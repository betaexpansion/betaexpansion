...
public class RenderItem extends Render
{
            ...
            float f, float f1)
    {
        ...
        int under = entityitem.worldObj.getBlockId(MathHelper.floor_double(entityitem.posX), MathHelper.floor_double(entityitem.boundingBox.minY) - 1, MathHelper.floor_double(entityitem.posZ));
        if(Block.blocksList[under] instanceof BlockTable){
            f2 = (-1f) * 0.1f + 0.1F;
        }
        ...
        if(itemstack.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType()))
        {
            ...
            loadTexture("/betaexpansion/terrain.png");
            float f4 = 0.25F;
            if(!Block.blocksList[itemstack.itemID].renderAsNormalBlock() 
               && itemstack.itemID != Block.stairSingle.blockID && Block.blocksList[itemstack.itemID].getRenderType() != 16
               && Block.blocksList[itemstack.itemID].getRenderType() != BERender.oreRenderID)
            {
                f4 = 0.5F;
            }
        ...
        } else
        {
            ...
            float f6 = (float)((i % 64) * 16 + 0) / 1024F;
            float f8 = (float)((i % 64) * 16 + 16) / 1024F;
            float f10 = (float)((i / 64) * 16 + 0) / 1024F;
            float f11 = (float)((i / 64) * 16 + 16) / 1024F;
            float f12 = 1.0F;
            float f13 = 0.5F;
            float f14 = 0.25F;
            if(field_27004_a)
    ...
    public void drawItemIntoGui(FontRenderer fontrenderer, RenderEngine renderengine, int i, int j, int k, int l, int i1)
    {
        ...
        {
            int j1 = i;
            renderengine.bindTexture(renderengine.getTexture("/betaexpansion/terrain.png"));
        ...
        if(k >= 0)
        {
            ...
            {
                renderengine.bindTexture(renderengine.getTexture("/betaexpansion/items.png"));
            }
            ...
            renderTexturedQuad(l, i1, (k % 64) * 16, (k / 64) * 16, 16, 16);
