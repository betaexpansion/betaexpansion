...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(1, width / 2 - 100, height / 4 + 120 + 12, 97, 20, stringtranslate.translateKey("gui.cancel")));
        controlList.add(new GuiButton(2, width / 2 + 4, height / 4 + 120 + 12, 97, 20 ,"Customize"));
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        if (guibutton.id == 2){
        	 mc.displayGuiScreen(new GuiCustomizeWorld(this));
        }
        if(guibutton.id == 1)
        {
    ...
    public static GuiTextField textboxWorldName;
    public static GuiTextField textboxSeed;
