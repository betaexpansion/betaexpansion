...
public class WorldInfo
{
    ...
    public WorldInfo(NBTTagCompound nbttagcompound)
    {
        ...
        year = nbttagcompound.getInteger("year");
        day = nbttagcompound.getInteger("day");
        timeScale = nbttagcompound.getInteger("timeScale");
        winterMode = nbttagcompound.getBoolean("wintermode");
        structures = nbttagcompound.getBoolean("structures");
        diffLock = nbttagcompound.getBoolean("diffLock");
    ...
    public WorldInfo(long l, String s)
    {
        ...
        season = GuiCustomizeWorld.season;
        if (season == 1){
        	season = GuiCustomizeWorld.seasonToStart;
        }
        timeScale = GuiCustomizeWorld.timescale;
        structures = GuiCustomizeWorld.structures;
        winterMode = GuiCustomizeWorld.season == 5; 
    }
    ...
    public WorldInfo(WorldInfo worldinfo)
    {
        ...
        day = worldinfo.day;
        year = worldinfo.year;
        timeScale = worldinfo.timeScale;
        winterMode = worldinfo.winterMode;
        structures = worldinfo.structures;
        diffLock = worldinfo.diffLock;
    }
    ...
    private void updateTagCompound(NBTTagCompound nbttagcompound, NBTTagCompound nbttagcompound1)
    {
        ...
        nbttagcompound.setInteger("day", day);
        nbttagcompound.setInteger("year", year);
        nbttagcompound.setInteger("timescale", timeScale);
        nbttagcompound.setBoolean("wintermode", winterMode);
        nbttagcompound.setBoolean("structures", structures);
        nbttagcompound.setBoolean("diffLock", diffLock);
