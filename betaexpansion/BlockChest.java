...
public class BlockChest extends BlockContainer
{
    ...
    protected BlockChest(int i)
    {
        ...
        random = new Random();
        blockIndexInTexture = Util.normalizeTexture(26);
    }
    ...
    public int getBlockTexture(IBlockAccess iblockaccess, int i, int j, int k, int l)
    {
        ...
        if(i1 == blockID || j1 == blockID)
        {
            ...
            return (l != byte1 ? blockIndexInTexture + 128 : blockIndexInTexture + 64) + i2;
        }
        if(k1 == blockID || l1 == blockID)
        {
            ...
            return (l != byte2 ? blockIndexInTexture + 128 : blockIndexInTexture + 64) + j2;
        }
        byte byte0 = 3;
