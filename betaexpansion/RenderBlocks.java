...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block block, int i, int j, int k)
    {
        ...
        if (l == BERender.oreRenderID){
        	return BERender.renderBlockOre(block, i, j, k, this, blockAccess);
        } else if (l == BERender.rushesRenderID){
        	return BERender.renderBlockRushes(block, i, j, k, this, blockAccess);
        } else if (l == BERender.lampRenderID){
        	return BERender.renderBlockLamp(block, i, j, k, this, blockAccess);
        } else if (l == BERender.tableRenderID){
        	return BERender.renderBlockTable(block, i, j, k, this, blockAccess);
        } else if (l == BERender.chairRenderID){
        	return BERender.renderBlockChair(block, i, j, k, this, blockAccess);
        } else if (l == BERender.jackOLanternRenderID){
        	return BERender.renderJackOLantern(block, i, j, k, this, blockAccess);
        }
    ...
    public boolean renderBlockBed(Block block, int i, int j, int k)
    {
        ...
        int k1 = (j1 & 0x3f) << 4;
        int l1 = (j1 - (k1 / 16)) >> 2;
        double d = (float)k1 / 1024F;
        double d1 = ((double)(k1 + 16) - 0.01D) / 1024D;
        double d2 = (float)l1 / 1024F;
        double d3 = ((double)(l1 + 16) - 0.01D) / 1024D;
        ...
        l1 = (k1 & 0x3f) << 4;
        d = (k1 - (l1 / 16)) >> 2;
        double d9 = (float)l1 / 1024F;
        double d10 = ((double)(l1 + 16) - 0.01D) / 1024D;
        double d11 = (float)d / 1024F;
        double d12 = ((d + 16D) - 0.01D) / 1024D;
        double d13 = d9;
        double d14 = d10;
        double d15 = d11;
        double d16 = d11;
    ...
    public boolean renderBlockRepeater(Block block, int i, int j, int k)
    {
        ...
        int l1 = (k1 & 0x3f) << 4;
        int i2 = (k1 - (l1 / 16)) >> 2;
        double d5 = (float)l1 / 1024F;
        double d6 = ((float)l1 + 15.99F) / 1024F;
        double d7 = (float)i2 / 1024F;
        double d8 = ((float)i2 + 15.99F) / 1024F;
        float f1 = 0.125F;
        float f2 = i + 1;
        float f3 = i + 1;
        float f4 = i + 0;
    ...
    {
        int i = Util.normalizeTexture(108);
        ...
        int k = (i - (j / 16)) >> 2;
        Tessellator tessellator = Tessellator.instance;
        double d7 = (float)(j + 0) / 1024F;
        double d8 = (float)(k + 0) / 1024F;
        double d9 = (((double)j + d6) - 0.01D) / 1024D;
        double d10 = ((double)((float)k + 4F) - 0.01D) / 1024D;
        tessellator.setColorOpaque_F(f, f, f);
    ...
    public boolean renderBlockLever(Block block, int i, int j, int k)
    {
        ...
        int k1 = (j1 & 0x3f) << 4;
        int l1 = (j1 - (k1 / 16)) >> 2;
        float f4 = (float)k1 / 1024F;
        float f5 = ((float)k1 + 15.99F) / 1024F;
        float f6 = (float)l1 / 1024F;
        float f7 = ((float)l1 + 15.99F) / 1024F;
        ...
        for(int j2 = 0; j2 < 6; j2++)
        {
            ...
            {
                f4 = (float)(k1 + 7) / 1024F;
                f5 = ((float)(k1 + 9) - 0.01F) / 1024F;
                f6 = (float)(l1 + 6) / 1024F;
                f7 = ((float)(l1 + 8) - 0.01F) / 1024F;
            } else
            if(j2 == 2)
            {
                f4 = (float)(k1 + 7) / 1024F;
    ...
    public boolean renderBlockFire(Block block, int i, int j, int k)
    {
        ...
        int i1 = (l & 0x3f) << 4;
        int j1 = (l - (i1 / 16)) >> 2;
        double d = (float)i1 / 1024F;
        double d1 = ((float)i1 + 15.99F) / 1024F;
        double d2 = (float)j1 / 1024F;
        double d3 = ((float)j1 + 15.99F) / 1024F;
        float f1 = 1.4F;
        ...
        } else
        {
            ...
            if(Block.fire.canBlockCatchFire(blockAccess, i, j + 1, k))
            {
                ...
                double d21 = (float)i1 / 1024F;
                double d22 = ((float)i1 + 15.99F) / 1024F;
                double d23 = (float)j1 / 1024F;
                double d24 = ((float)j1 + 15.99F) / 1024F;
                j++;
                float f4 = -0.2F;
                if((i + j + k & 1) == 0)
                {
    ...
    public boolean renderBlockRedstoneWire(Block block, int i, int j, int k)
    {
        ...
        int j1 = (i1 & 0x3f) << 4;
        int k1 = (i1 - (j1 / 16)) >> 2;
        double d = (float)j1 / 1024F;
        double d1 = ((float)j1 + 15.99F) / 1024F;
        double d2 = (float)k1 / 1024F;
        double d3 = ((float)k1 + 15.99F) / 1024F;
        ...
        {
            d = (float)(j1 + 16) / 1024F;
            d1 = ((float)(j1 + 16) + 15.99F) / 1024F;
            d2 = (float)k1 / 1024F;
            d3 = ((float)k1 + 15.99F) / 1024F;
        }
        if(byte0 == 0)
        {
            ...
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d1, d3 + 0.015625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f6, d1, d2 + 0.015625D);
            tessellator.addVertexWithUV(f4, (float)j + 0.015625F, f6, d, d2 + 0.015625D);
            tessellator.addVertexWithUV(f4, (float)j + 0.015625F, f7, d, d3 + 0.015625D);
        } else
        if(byte0 == 1)
        {
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d1, d3);
        ...
        if(byte0 == 2)
        {
            ...
            tessellator.setColorOpaque_F(f, f, f);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f7, d1, d3 + 0.015625D);
            tessellator.addVertexWithUV(f5, (float)j + 0.015625F, f6, d, d3 + 0.015625D);
            tessellator.addVertexWithUV(f4, (float)j + 0.015625F, f6, d, d2 + 0.015625D);
            tessellator.addVertexWithUV(f4, (float)j + 0.015625F, f7, d1, d2 + 0.015625D);
        }
        if(!blockAccess.isBlockNormalCube(i, j + 1, k))
        {
            double d4 = (float)(j1 + 16) / 1024F;
            double d5 = ((float)(j1 + 16) + 15.99F) / 1024F;
            double d6 = (float)k1 / 1024F;
            double d7 = ((float)k1 + 15.99F) / 1024F;
            if(blockAccess.isBlockNormalCube(i - 1, j, k) && blockAccess.getBlockId(i - 1, j + 1, k) == Block.redstoneWire.blockID)
            {
                ...
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((float)i + 0.015625F, (float)(j + 1) + 0.021875F, k + 1, d5, d6 + 0.015625D);
                tessellator.addVertexWithUV((float)i + 0.015625F, j + 0, k + 1, d4, d6 + 0.015625D);
                tessellator.addVertexWithUV((float)i + 0.015625F, j + 0, k + 0, d4, d7 + 0.015625D);
                tessellator.addVertexWithUV((float)i + 0.015625F, (float)(j + 1) + 0.021875F, k + 0, d5, d7 + 0.015625D);
            }
            if(blockAccess.isBlockNormalCube(i + 1, j, k) && blockAccess.getBlockId(i + 1, j + 1, k) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f1, f * f2, f * f3);
                ...
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV((float)(i + 1) - 0.015625F, j + 0, k + 1, d4, d7 + 0.015625D);
                tessellator.addVertexWithUV((float)(i + 1) - 0.015625F, (float)(j + 1) + 0.021875F, k + 1, d5, d7 + 0.015625D);
                tessellator.addVertexWithUV((float)(i + 1) - 0.015625F, (float)(j + 1) + 0.021875F, k + 0, d5, d6 + 0.015625D);
                tessellator.addVertexWithUV((float)(i + 1) - 0.015625F, j + 0, k + 0, d4, d6 + 0.015625D);
            }
            if(blockAccess.isBlockNormalCube(i, j, k - 1) && blockAccess.getBlockId(i, j + 1, k - 1) == Block.redstoneWire.blockID)
            {
                ...
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(i + 1, j + 0, (float)k + 0.015625F, d4, d7 + 0.015625D);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (float)k + 0.015625F, d5, d7 + 0.015625D);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (float)k + 0.015625F, d5, d6 + 0.015625D);
                tessellator.addVertexWithUV(i + 0, j + 0, (float)k + 0.015625F, d4, d6 + 0.015625D);
            }
            if(blockAccess.isBlockNormalCube(i, j, k + 1) && blockAccess.getBlockId(i, j + 1, k + 1) == Block.redstoneWire.blockID)
            {
                tessellator.setColorOpaque_F(f * f1, f * f2, f * f3);
                ...
                tessellator.setColorOpaque_F(f, f, f);
                tessellator.addVertexWithUV(i + 1, (float)(j + 1) + 0.021875F, (float)(k + 1) - 0.015625F, d5, d6 + 0.015625D);
                tessellator.addVertexWithUV(i + 1, j + 0, (float)(k + 1) - 0.015625F, d4, d6 + 0.015625D);
                tessellator.addVertexWithUV(i + 0, j + 0, (float)(k + 1) - 0.015625F, d4, d7 + 0.015625D);
                tessellator.addVertexWithUV(i + 0, (float)(j + 1) + 0.021875F, (float)(k + 1) - 0.015625F, d5, d7 + 0.015625D);
            }
        }
        return true;
    }
    ...
    public boolean renderBlockReed(Block block, int i, int j, int k)
    {
        ...
        boolean snowy = false;
        int meta = 0;
        if (blockAccess.getBlockId(i + 1, j, k) == Block.snow.blockID){
        	snowy = true;
        	meta = Math.max(meta, blockAccess.getBlockMetadata(i + 1, j, k));
        } else if (blockAccess.getBlockId(i, j, k + 1) == Block.snow.blockID){
        	snowy = true;
        	meta = Math.max(meta, blockAccess.getBlockMetadata(i, j, k + 1));
        } else if (blockAccess.getBlockId(i - 1, j, k) == Block.snow.blockID){
        	snowy = true;
        	meta = Math.max(meta, blockAccess.getBlockMetadata(i - 1, j, k));
        } else if (blockAccess.getBlockId(i, j, k - 1) == Block.snow.blockID){
        	snowy = true;
        ...
        if (snowy){
        	BlockSnow.metaOverride = meta;
        	this.renderStandardBlock(Block.snow, i, j, k);
        	BlockSnow.metaOverride = -1;
        }
            ...
            double d3, double d4)
    {
        ...
        int j = (i & 0x3f) << 4;
        int k = (i - (j / 16)) >> 2;
        float f = (float)j / 1024F;
        float f1 = ((float)j + 15.99F) / 1024F;
        float f2 = (float)k / 1024F;
        float f3 = ((float)k + 15.99F) / 1024F;
        double d5 = (double)f + 0.02734375D / 4;
        double d6 = (double)f2 + 0.0234375D / 4;
        double d7 = (double)f + 0.03515625D / 4;
        double d8 = (double)f2 + 0.03125D / 4;
        d += 0.5D;
        d2 += 0.5D;
        double d9 = d - 0.5D;
        double d10 = d + 0.5D;
    ...
    public void renderCrossedSquares(Block block, int i, double d, double d1, double d2)
    {
        ...
        int k = (j & xAnd) << 4;
        int l = (j - (k / 16)) >> 2;
        double d3 = (float)k / 1024F;
        double d4 = ((float)k + 15.99F) / 1024F;
        double d5 = (float)l / 1024F;
        double d6 = ((float)l + 15.99F) / 1024F;
    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k)
    {
        ...
        if(renderAllFaces || flag)
        {
            ...
            int k2 = (j1 - (i2 / 16)) >> 2;
            //k2 *= 16;
            double d2 = ((double)i2 + 8D) / 1024D;
            double d3 = ((double)k2 + 8D) / 1024D;
            if(f12 < -999F)
            {
                f12 = 0.0F;
            } else
            {
                d2 = (float)(i2 + 16) / 1024D;
                d3 = (float)(k2 + 16) / 1024D;
            }
            float f14 = (MathHelper.sin(f12) * 8F) / 1024F;
            float f16 = (MathHelper.cos(f12) * 8F) / 1024F;
        ...
        for(int k1 = 0; k1 < 4; k1++)
        {
            ...
            if(renderAllFaces || aflag[k1])
            {
                ...
                flag2 = true;
                double d4 = (float)(j3 + 0) / 1024F;
                double d5 = ((double)(j3 + 16) - 0.01D) / 1024D;
                double d6 = ((float)k3 + (1.0F - f13) * 16F) / 1024F;
                double d7 = ((float)k3 + (1.0F - f15) * 16F) / 1024F;
                double d8 = ((double)(k3 + 16) - 0.01D) / 1024D;
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            ...
            if(cfgGrassFix && block.blockID == Block.grass.blockID && overrideBlockTexture < 0 && !blockAccess.getBlockMaterial(i, j + 1, k).equals(Material.snow))
            {
                colorRedTopLeft *= f;
                ...
                renderEastFace(block, i, j, k, BlockGrass.getOverlay(blockAccess, i, j, k));
            }
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            ...
            if(cfgGrassFix && block.blockID == Block.grass.blockID && overrideBlockTexture < 0 && !blockAccess.getBlockMaterial(i, j + 1, k).equals(Material.snow))
            {
                ...
                colorBlueBottomRight *= f2;
                colorBlueTopRight *= f2;
                renderWestFace(block, i, j, k, BlockGrass.getOverlay(blockAccess, i, j, k));
            }
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            ...
            if(cfgGrassFix && block.blockID == Block.grass.blockID && overrideBlockTexture < 0 && !blockAccess.getBlockMaterial(i, j + 1, k).equals(Material.snow))
            {
                ...
                colorBlueBottomRight *= f2;
                colorBlueTopRight *= f2;
                renderNorthFace(block, i, j, k, BlockGrass.getOverlay(blockAccess, i, j, k));
            }
            flag = true;
        }
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            ...
            if(cfgGrassFix && block.blockID == Block.grass.blockID && overrideBlockTexture < 0 && !blockAccess.getBlockMaterial(i, j + 1, k).equals(Material.snow))
            {
                ...
                colorBlueBottomRight *= f2;
                colorBlueTopRight *= f2;
                renderSouthFace(block, i, j, k, BlockGrass.getOverlay(blockAccess, i, j, k));
            }
            flag = true;
        }
        enableAO = false;
            ...
            int i)
    {
        ...
        int j = (i & xAnd) << 4;
        int k = (int) Math.floor(i / 64f);
        k *= 16;
        
        double d3 = ((double)j + block.minX * 16D) / 256D * texSize;
        double d4 = (((double)j + block.maxX * 16D) - 0.01D) / 256D * texSize;
        double d5 = ((double)k + block.minZ * 16D) / 256D * texSize;
        double d6 = (((double)k + block.maxZ * 16D) - 0.01D) / 256D * texSize;
        if(block.minX < 0.0D || block.maxX > 1.0D)
        {
            d3 = ((float)j + 0.0F) / 256F * texSize;
            d4 = ((float)j + 15.99F) / 256F * texSize;
        }
        if(block.minZ < 0.0D || block.maxZ > 1.0D)
        {
            d5 = ((float)k + 0.0F) / 256F * texSize;
            d6 = ((float)k + 15.99F) / 256F * texSize;
        }
        double d7 = d4;
        double d8 = d3;
        double d9 = d5;
        ...
        if(field_31082_l == 2)
        {
            d3 = ((double)j + block.minZ * 16D) / 256D * texSize;
            d5 = ((double)(k + 16) - block.maxX * 16D) / 256D * texSize;
            d4 = ((double)j + block.maxZ * 16D) / 256D * texSize;
            d6 = ((double)(k + 16) - block.minX * 16D) / 256D * texSize;
            d7 = d4;
            d8 = d3;
            d9 = d5;
            d10 = d6;
        ...
        if(field_31082_l == 1)
        {
            d3 = ((double)(j + 16) - block.maxZ * 16D) / 256D * texSize;
            d5 = ((double)k + block.minX * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.minZ * 16D) / 256D * texSize;
            d6 = ((double)k + block.maxX * 16D) / 256D * texSize;
            d7 = d4;
            d8 = d3;
            d9 = d5;
            d10 = d6;
        ...
        if(field_31082_l == 3)
        {
            d3 = ((double)(j + 16) - block.minX * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.maxX * 16D - 0.01D) / 256D * texSize;
            d5 = ((double)(k + 16) - block.minZ * 16D) / 256D * texSize;
            d6 = ((double)(k + 16) - block.maxZ * 16D - 0.01D) / 256D * texSize;
            d7 = d4;
            d8 = d3;
            d9 = d5;
            d10 = d6;
            ...
            int i)
    {
        ...
        double d3 = ((double)j + block.minX * 16D) / 256D * texSize;
        double d4 = (((double)j + block.maxX * 16D) - 0.01D) / 256D * texSize;
        double d5 = ((double)(k + 16) - block.maxY * 16D) / 256D * texSize;
        double d6 = ((double)(k + 16) - block.minY * 16D - 0.01D) / 256D * texSize;
        if(flipTexture)
        {
            double d7 = d3;
            d3 = d4;
        ...
        if(field_31087_g == 2)
        {
            d3 = ((double)j + block.minY * 16D) / 256D * texSize;
            d5 = ((double)(k + 16) - block.minX * 16D) / 256D * texSize;
            d4 = ((double)j + block.maxY * 16D) / 256D * texSize;
            d6 = ((double)(k + 16) - block.maxX * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
        ...
        if(field_31087_g == 3)
        {
            d3 = ((double)(j + 16) - block.minX * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.maxX * 16D - 0.01D) / 256D * texSize;
            d5 = ((double)k + block.maxY * 16D) / 256D * texSize;
            d6 = (((double)k + block.minY * 16D) - 0.01D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
            ...
            int i)
    {
        ...
        if(field_31086_h == 2)
        {
            d3 = ((double)(j + 16) - block.maxY * 16D) / 256D * texSize;
            d5 = ((double)k + block.minX * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.minY * 16D) / 256D * texSize;
            d6 = ((double)k + block.maxX * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            ...
            int i)
    {
        ...
        double d3 = ((double)j + block.minZ * 16D) / 256D * texSize;
        double d4 = (((double)j + block.maxZ * 16D) - 0.01D) / 256D * texSize;
        double d5 = ((double)(k + 16) - block.maxY * 16D) / 256D * texSize;
        double d6 = ((double)(k + 16) - block.minY * 16D - 0.01D) / 256D * texSize;
        if(flipTexture)
        {
        ...
        {
            d3 = ((double)j + block.minY * 16D) / 256D * texSize;
            d5 = ((double)(k + 16) - block.maxZ * 16D) / 256D * texSize;
            d4 = ((double)j + block.maxY * 16D) / 256D * texSize;
            d6 = ((double)(k + 16) - block.minZ * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
        ...
        {
            d3 = ((double)(j + 16) - block.maxY * 16D) / 256D * texSize;
            d5 = ((double)k + block.minZ * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.minY * 16D) / 256D * texSize;
            d6 = ((double)k + block.maxZ * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
        ...
        if(field_31084_j == 3)
        {
            d3 = ((double)(j + 16) - block.minZ * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.maxZ * 16D - 0.01D) / 256D * texSize;
            d5 = ((double)k + block.maxY * 16D) / 256D * texSize;
            d6 = (((double)k + block.minY * 16D) - 0.01D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            ...
            int i)
    {
        ...
        if(field_31085_i == 2)
        {
            ...
            d5 = ((double)(k + 16) - block.minZ * 16D) / 256D * texSize;
            d4 = ((double)j + block.maxY * 16D) / 256D * texSize;
            d6 = ((double)(k + 16) - block.maxZ * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
        ...
        {
            d3 = ((double)(j + 16) - block.maxY * 16D) / 256D * texSize;
            d5 = ((double)k + block.maxZ * 16D) / 256D * texSize;
            d4 = ((double)(j + 16) - block.minY * 16D) / 256D * texSize;
            d6 = ((double)k + block.minZ * 16D) / 256D * texSize;
            d8 = d4;
            d9 = d3;
            d10 = d5;
            d11 = d6;
    ...
    public void renderBlockOnInventory(Block block, int i, float f)
    {
        ...
        if(k == 0 || k == 16)
        {
            ...
            tessellator.draw();
            GL11.glTranslatef(0.5F, 0.5F, 0.5F);
        }else if (k == BERender.oreRenderID){ 
            renderBlockOnInventory(Block.stone, i, f);
            block.setBlockBoundsForItemRender();
            GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, -1F, 0.0F);
        ...
        else if (k == BERender.chairRenderID){
        	BERender.renderChairInv(block, this);
        } else if (k == BERender.tableRenderID){
        	BERender.renderTableInv(block, this);
        }
        else{
    ...
    {
        if(i == 0 || i == BERender.oreRenderID || i == BERender.chairRenderID || i == BERender.tableRenderID)
        {
            return true;
        }
        if(i == 13)
