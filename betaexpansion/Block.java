...
public class Block
{
    ...
    {
        this(i, material);
        blockIndexInTexture = Util.normalizeTexture(j);
    }
    ...
    public boolean canPlaceBlockAt(World world, int i, int j, int k)
    {
        ...
        return l == 0 || blocksList[l].blockMaterial.getIsGroundCover() || blocksList[l] instanceof BlockReed || blocksList[l] instanceof BlockFlower;
    }
    ...
    static 
    {
        ...
        cobblestone = (new BlockCobblestone(4, 16)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stonebrick");
