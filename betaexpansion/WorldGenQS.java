...
public class WorldGenQS extends WorldGenerator {

    public WorldGenQS(int i, int j)
    {
    	this(i, j, 0);
    }
    
    public WorldGenQS(int i, int j, int meta){
        minableBlockId = i;
        numberOfBlocks = j;
        this.meta = meta;
    }
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                     ...
                     || world.getBlockId(k2, l2, i3) == Block.dirt.blockID
                     || world.getBlockId(k2, l2, i3) == Block.sand.blockID))
                        {
