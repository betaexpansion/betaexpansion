...
public class WorldGenApple extends WorldGenerator {
	...
	public WorldGenApple(boolean flag)
    {
		if (flag){
	  ...
	  public boolean generate(World world, Random random, int i, int j, int k)
	    {
	        if (flag){
	        	return generateBig(world, random, i, j, k);
	        }
	  ...
	  void func_521_a()
	                ...
	                } else
	                {
	                    ...
	                    } else
	                    {
	                        ...
	                        if (random.nextInt(10) == 0){
		                        worldObj.setBlock(ai1[0], ai1[1], ai1[2], BEBlocks.appleLeaves.blockID);
	                        }
	                        l1++;
	                    }
	                }
	    ...
	    public boolean generateBig(World world, Random random, int i, int j, int k)
	    {
	        worldObj = world;
