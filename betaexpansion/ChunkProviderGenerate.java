    ...
    implements IChunkProvider
{
    ...
    public Chunk provideChunk(int i, int j)
    {
        ...
        abyte0 = BEWorldgen.processOverworldChunk(abyte0, worldObj, biomesForGeneration);
        field_902_u.func_867_a(this, worldObj, i, j, abyte0);
        
        Chunk chunk = new Chunk(worldObj, abyte0, i, j);
        chunk = BEWorldgen.addOverworldMetadata(i, j, chunk, worldObj);
        chunk.func_1024_c();
        return chunk;
    }
    ...
    {
        BEWorldgen.populate(worldObj, i, j);
        ...
        {
            byte byte2 = -1;
            int id = BEBlocks.wildGrass.blockID;
            if(biomegenbase == BiomeGenBase.rainforest && rand.nextInt(10) != 0)
            {
                byte2 = 2;
            ...
            (new WorldGenTallGrass(id, byte2)).generate(worldObj, rand, l19, k22, j24);
        }
